...
{
    public class BaseReferenceConverter : IReferenceConverter
    {
        #region Fields
        ...
        public string ReferenceToBookLink(Reference reference)
        {
            throw new NotImplementedException();
        }

        public string ReferenceToCommentaryLink(Reference reference)
        {
            throw new NotImplementedException();
        }
        ...
        public string ReferenceToReadableString(Reference reference)
        {
            ...
            if (bookIndex >= 0)
            {
                if (reference.FromVerse == reference.ToVerse)
                    return $"{BookList.Keys.ToList()[bookIndex]} {reference.Chapter}:{reference.FromVerse}";
                else
                    return $"{BookList.Keys.ToList()[bookIndex]} {reference.Chapter}:{reference.FromVerse}-{reference.ToVerse}";
            }
            else
            {
                return string.Empty;
